...
class AnimeGANv3(object):
    ...
    def build_train(self):
        ...
        """ Define Loss """
        # init G
        self.Pre_train_G_loss = con_loss(
            self.real_photo, self.generated) + con_loss(self.real_photo, self.generated_m)
        ...
        self.s22, self.s33, self.s44 = style_loss_decentralization_3(
            self.anime_sty_gray, self.fake_sty_gray,  [0.1, 5., 25.])
        ...
        for epoch in range(start_epoch, self.epoch):
            ...
            if (epoch + 1) >= self.init_G_epoch:
                ...
                for i, sample_file in enumerate(val_files):
                    ...
                    val_real, test_s1, test_s0, test_m = self.sess.run(
